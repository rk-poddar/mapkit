    ...
    return (
      <main className="page-shell">
        <section className="setup-panel">
          ...
          <p>Add NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN to run this example.</p>
          <code>NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN=pk.your_token</code>
        </section>
      </main>
    );
  }
      ...
      <section className="map-panel">
        ...
        >
          ...
          <Marker id="delhi" position={delhi} title="New Delhi" color="#2563eb">
            <Popup>Mapbox marker rendered by Map Kit.</Popup>
          </Marker>
